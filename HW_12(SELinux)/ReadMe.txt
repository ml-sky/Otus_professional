...
2. Обеспечить работоспособность приложения при включенном selinux:
	...
	2.2 Переходим под root
		...
		2.3 Способ второй.Проверяем все ошибки SELinux последовательно и создаем модули по их исправлению
		...
		2.4 Еще есть самый примитивный способ - выключить SELinux. Данный вариант не рекомендуется.
